  ...
  cards = [
    {
      ...
      description: 'Zapisz swoje dziecko do Polyglot Kids, aby odkrywało nowe możliwości i uczyło się angielskiego, hiszpańskiego lub niemieckiego od profesjonalistów',
      linkText: 'Zapisz się',
    ...
    },
    {
      ...
      description: 'Odkryj ciekawe artykuły edukacyjne dla rodziców i uczniów! Od porad językowych po kreatywne aktywności - sprawdź, jak nauka angielskiego, hiszpańskiego lub niemieckiego może być wciągająca i inspirująca.',
      linkText: 'Więcej',
      link: '/blogs'
    }
  ];
